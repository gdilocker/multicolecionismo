...
import { LayoutDashboard, Mail, Globe, CreditCard, Settings, HelpCircle, LogOut, ChevronLeft, ChevronRight, Store, User, Users, CreditCard as Edit3, PlusCircle, BarChart3, ShoppingBag, X, Activity, ToggleLeft, FileEdit } from 'lucide-react'; import { Crown } from 'lucide-react';
...
export const PanelSidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen, backRoute }) => {
  ...
  const menuItems = [
    ...
    { path: '/panel/domains', icon: Globe, label: 'Gerenciar', subtitle: 'Domínio' },
    { path: '/panel/profile', icon: FileEdit, label: 'Gerenciar Página', subtitle: 'Página', badge: !userStatus.hasProfile ? 'Criar Página' : undefined },
