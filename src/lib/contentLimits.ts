export const CONTENT_LIMITS = {
  ...
  LINKS: {
    ...
    ELITE_MAX: 10,
    SUPREME_MAX: 10,
    ERROR_MESSAGE_PRIME: 'Você atingiu o limite de 5 links do plano Prime.',
...
export function validateLinksCount(count: number, planName: string): { valid: boolean; error?: string } {
  const isPrime = planName === 'Prime';
...
export function validateMediaCount(count: number): { valid: boolean; error?: string } {
...
export function validateMediaSize(sizeBytes: number): { valid: boolean; error?: string } {
...
export function validateExtraField(text: string): { valid: boolean; error?: string } {
...
export function validateHashtagsCount(count: number): { valid: boolean; error?: string } {
